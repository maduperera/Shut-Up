...
final class AlarmModel {
    ...
    /**
     * @return whether snooze by voice is enabled for timers.
     */
    boolean getSnoozeByVoice() {
        return mSettingsModel.getSnoozeByVoice();
    }

    /**
     * @param enabled whether the snooze by voice
     */
    void setSnoozeByVoice(boolean enabled) {
        mSettingsModel.setSnoozeByVoice(enabled);
    }
