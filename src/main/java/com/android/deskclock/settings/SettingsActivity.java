...
public final class SettingsActivity extends BaseActivity {
    ...
    public static final String KEY_SNOOZE_BY_VOICE = "snooze_by_voice";
        ...
        public boolean onPreferenceChange(Preference pref, Object newValue) {
            ...
            switch (pref.getKey()) {
                ...
                case KEY_TIMER_RINGTONE:
                    ...
                    break;
                case KEY_SNOOZE_BY_VOICE:
                    final TwoStatePreference snoozeByVoicePref = (TwoStatePreference) pref;
                    DataModel.getDataModel().setSnoozeByVoice(snoozeByVoicePref.isChecked());
                    break;
            }
